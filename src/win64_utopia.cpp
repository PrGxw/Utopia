...
internal void
Win64FillSoundBuffer(win64_sound_output *SoundOutput, DWORD ByteToLock, DWORD BytesToWrite)
{
                                              ...
                                              0)))
    {
             ...
             ++SampleIndex)
        {
            ...
            int16 SampleValue = (int16)(SineValue * SoundOutput->Magnitude);
