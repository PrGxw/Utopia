...
static void
ResizeDIBSection(Win64ScreenBuffer *Buffer,
                 Win64ScreenBuffer *ZBuffer,
...
void InitZBUffer(Win64ScreenBuffer *Buffer)
{
...
bool IsInFront(Win64ScreenBuffer* ZBuffer, Win64ScreenBuffer* Buffer,
...
static void
FillScreenBuffer(Win64ScreenBuffer *Buffer, Win64ScreenBuffer *ZBuffer)
{
    ...
    for (int shape_index = 0; shape_index < MatrixRowSize(shapes); shape_index++)
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            *(((Point*)image_points.geometry)+i) = image_point;
            ...
            if ((ndc_point.x > 1) || (ndc_point.y > 1) || (vertex->z >= 0) || (ndc_point.x < 0) || (ndc_point.y < 0)) continue;
    ...
    if (RegisterClassA(&WindowClass))
    {
        ...
        if (Window)
        {
            ...
            while (GlobalRunning)
            {
                ...
                FillScreenBuffer(&ScreenBuffer, &ZBuffer);
